...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <!-- Page Header Start -->
        <div class="container-fluid page-header mb-5 p-0" style="background-image: url(https://i.pinimg.com/236x/09/80/52/09805251e8b42816ec721609d0e1c263.jpg);">
        ...
        <div class="container-xxl py-5 w-50">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h1 class="mb-5"><span class="text-primary text-uppercase">Login</span> To Explore Our Services</h1>
                </div>
                            ...
                            <form style="align-content: center">
                                <div class="row g-3 ">
                                    <div class="col-md-6 ">
                                            ...
                                            <label class="p-2" for="radioOne" class="radio" chec>Landlord</label>

                                            <input type="radio" value="None" id="radioTwo" name="account" />
                                            <label class="p-2" for="radioTwo" class="radio">Student</label>
                <br>
                <br>
                                    ...
                                    <div class="col-md-6 w-100">
                                        <div class="form-floating">
                                            ...
                                            <label for="email"><i class="fa fa-user-circle m-2" aria-hidden="true"> </i>Username</label>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-md-6 w-100">
                                        <div class="form-floating">
                                            <input type="email" class="form-control" id="email" placeholder="Your Email">
                                            <label for="email"><i class="fa fa-key m-2" aria-hidden="true"> </i>Password</label>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="col-md-6 w-100">
                            ...
                            <br>
                            <h5>Don't have an account? Click <a href="register-Hommie.html"> here </a> to register </h5>
                        </div>
                    </div>
                </div>
            </div>
