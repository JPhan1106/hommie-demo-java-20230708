...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <!-- Page Header Start -->
        <div class="container-fluid page-header mb-5 p-0" style="background-image: url(https://i.pinimg.com/236x/04/b5/db/04b5dbe08ed9a345aa1bec7e359358c3.jpg);">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h1 class="mb-5"><span class="text-primary text-uppercase">Register</span> To Explore Our Services</h1>
                </div>
                <div class="center-form">
                            <form class="justify-content-center w-50" style="margin-left:auto; margin-right: auto;">
                                <div class="row g-3">
                                    <div class="d-flex flex-lg-row">
                                        <div class="p-2">
                                            <input type="radio" value="None" id="radioOne" name="account" checked/>
                                            <label for="radioOne" class="radio" chec> Landlord</label>
                                        </div>
                                        <div class="p-2">
                                    ...
                                    <div class="row g-3">
                                        <div class="form-floating">
                                            ...
                                            <label for="email"><i class="fa fa-user-circle" aria-hidden="true" style="padding: 0 10px"></i> Enter Username</label>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row g-3">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="new-password" placeholder="Your New Password">
                                    ...
                                    <div class="row g-3">
                                        <div class="form-floating">
                                            ...
                                            <label for="text"><i class="fa fa-key" aria-hidden="true" style="padding: 0 10px"></i>  Re-enter Password</label>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row g-3">
                                    ...
                                    <div class="row g-3">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="last-name" placeholder="Your Last Name" style="padding: 0 10px">
                                            <label for="email"><label for="first-name"><i class="fa fa-keyboard" style="padding: 0 10px"></i> Enter Last Name</label>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row g-3">
                                        <div class="form-floating">
                                            ...
                                            <label for="email"><i class="fa fa-envelope" aria-hidden="true" style="padding: 0 10px"></i> Enter Email Addess</label>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row g-3">
                                ...
                                <br>
                                <p>By clicking Register, you agree with our <a href="tAndC.html">terms and conditions.</a><p></p>
                            </form>
